...
| :--- | :--- |
| **HTML5** | Estruturação semântica da interface e telas do chat. |
| **CSS3** | Estilização responsiva, variáveis de cor e suporte ao Dark Mode. |
| **JavaScript (ES6+)** | Consumo de API via `fetch`, manipulação da DOM e regras de negócio. |
| **Google Gemini API** | Processamento de linguagem natural (modelo `gemini-3.6-flash`). |
| **GitHub Pages** | Servidor estático para publicação pública e gratuita. |
